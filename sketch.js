...
function preload() {
  ...
  monkey_running = loadAnimation("image-removebg-preview(1).png", "image-removebg-preview(2).png", "image-removebg-preview(3).png", "image-removebg-preview(4).png", "image-removebg-preview(5).png", "image-removebg-preview(6).png", "image-removebg-preview(7).png", "image-removebg-preview(8).png")
  monkeyStop = loadImage("image-removebg-preview(1).png");
 

  bananaImage = loadImage("image-removebg-preview(9).png");
  obstacleImage = loadImage("image-removebg-preview(13).png");
  groundImage = loadImage("jungle.jpg"); 

  gameOverImage = loadImage("image-removebg-preview(10).png");

  retryImage = loadImage("image-removebg-preview(14).png");
...
function setup() {
  ...
  retry = createSprite(200,200, 10, 10);
